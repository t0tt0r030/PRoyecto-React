...
function Contacto() {
  ...
  const Navbar = () => (
    <header className="contacto-navbar-header">
      <nav className="navbar navbar-expand-lg contacto-navbar">
        <div className="container">
          <a className="contacto-navbar-brand" href="/">Pastelería Mil Sabores</a>
          <button
          ...
          >
            <span className="contacto-navbar-toggler-icon"></span>
          </button>

          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="contacto-navbar-nav ms-auto">
              <li className="contacto-nav-item"><a className="contacto-nav-link" href="/">Home</a></li>
              <li className="contacto-nav-item"><a className="contacto-nav-link" href="/nosotros.html">Nosotros</a></li>
              <li className="contacto-nav-item"><a className="contacto-nav-link" href="/productos.html">Productos</a></li>
              <li className="contacto-nav-item"><a className="contacto-nav-link contacto-nav-link-active" href="/contacto.html">Contacto</a></li>
            </ul>

            <div className="contacto-login ms-lg-3">
              {isLoggedIn ? (
                <button className="contacto-btn-account" onClick={() => setIsLoggedIn(false)}>
                  <User size={18} className="me-2" /> Mi Cuenta
                </button>
              ) : (
                <button className="contacto-btn-login" onClick={() => setIsLoggedIn(true)}>
                  Iniciar Sesión
                </button>
              )}
            </div>
